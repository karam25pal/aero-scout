...
// Comprehensive airline name → website domain mapping for Clearbit logos
const AIRLINE_DOMAINS: Record<string, string> = {
  ...
  'copa airlines': 'copa.com',
  'croatia airlines': 'croatiaairlines.hr',
  ...
  'shenzhen airlines': 'shenzhenair.com',
  ...
  'aerolineas argentinas': 'aerolineas.com',
  ...
  'middle east airlines': 'mea.com.lb',
  'mea': 'mea.com.lb',
  'saudia': 'saudia.com',
  ...
  'norse atlantic uk': 'flynorse.com',
  ...
  'solomon airlines': 'flysolomons.com',
  'air vanuatu': 'airvanuatu.com',
  'air caledonie': 'air-caledonie.nc',
  'rex airlines': 'rex.com.au',
  'air north': 'flyairnorth.com',
  'wamos air': 'wamosair.com',
  'binter canarias': 'bintercanarias.com',
  'air dolomiti': 'airdolomiti.eu',
  'luxair': 'luxair.lu',
  'sun express': 'sunexpress.com',
  'sunexpress': 'sunexpress.com',
  'corendon airlines': 'corendonairlines.com',
  'flyone': 'flyone.eu',
  'tui fly': 'tuifly.com',
  'tui': 'tui.com',
  'neos': 'neosair.it',
  'blue air': 'blueairweb.com',
  'air arabia': 'airarabia.com',
  'jazeera airways': 'jazeeraairways.com',
  'air cairo': 'aircairo.com',
  'nile air': 'nileair.com',
  'rwandair': 'rwandair.com',
  'air mauritius': 'airmauritius.com',
  'air seychelles': 'airseychelles.com',
  'air austral': 'air-austral.com',
  'air madagascar': 'airmadagascar.com',
  'mango airlines': 'flymango.com',
  'kulula': 'kulula.com',
  'fastjet': 'fastjet.com',
  'precision air': 'precisionairtz.com',
  'air burkina': 'air-burkina.com',
  'asky airlines': 'flyasky.com',
  'air peace': 'flyairpeace.com',
  'arik air': 'arikair.com',
  'badr airlines': 'badrairlines.com',
  'sriwijaya air': 'sriwijayaair.co.id',
  'wings air': 'lionair.co.id',
  'citilink': 'citilink.co.id',
  'nam air': 'flynamair.com',
  'silk air': 'silkair.com',
  'myanmar airways': 'maiair.com',
  'lao airlines': 'laoairlines.com',
  'cambodia angkor air': 'cambodiaangkorair.com',
  'air koryo': 'airkoryo.com.kp',
  'mongolian airlines': 'miat.com',
  'miat': 'miat.com',
  'pakistan international airlines': 'piac.com.pk',
  'pia': 'piac.com.pk',
  'biman bangladesh airlines': 'bfrbd.com',
  'nepal airlines': 'nepalairlines.com.np',
  'druk air': 'drukair.com.bt',
};

const getAirlineLogo = (name: string, logoUrl: string): string => {
  const lowerName = name?.toLowerCase().trim() || '';

  // Try domain-based Clearbit logo first (most reliable)
  const domain = AIRLINE_DOMAINS[lowerName];
  if (domain) return `https://logo.clearbit.com/${domain}`;

  // If provider gives a valid non-Google URL, use it
  if (logoUrl && !logoUrl.includes('gstatic.com/flights')) return logoUrl;

  // Last fallback: guess domain from cleaned name
