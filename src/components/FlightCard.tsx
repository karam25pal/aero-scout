...
// Comprehensive airline name → ICAO code mapping (from aidbev airlines.json + extras)
const AIRLINE_ICAO: Record<string, string> = {
  ...
  'norse atlantic': 'NBT',
  'norse atlantic uk': 'UBT',
  'norwegian air shuttle': 'NOZ',
  'norwegian': 'NOZ',
  'play': 'FPY',
  'porter airlines': 'POE',
  'ryanair': 'RYR',
  'azores airlines': 'RZO',
  'seaborne airlines': 'SBS',
  'silver airways': 'SIL',
